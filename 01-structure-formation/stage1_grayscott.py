...
CRITICAL for the structure-formation test: initial condition must be genuinely uniform plus
...
def uniform_init(n_rows, n_cols, rng, noise_scale=0.01):
    ...
    'undifferentiated potential' condition this test needs to start from.
    """
...
def small_seed_init(n_rows, n_cols, rng, noise_scale=0.01, seed_radius=16):
    ...
    not the structure-formation test itself. We use it here only to confirm our
