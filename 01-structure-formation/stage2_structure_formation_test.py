...
This is the real test of spontaneous structure formation: can an undifferentiated
medium spontaneously partition itself into distinct regions,
...
if __name__ == "__main__":
    ...
    if final_std > initial_std * 3 and V.mean() > 0.001:
        ...
        print("This supports spontaneous structure formation: distinct regions can arise from")
        print("an undifferentiated medium via local dynamics alone.")
    else:
        ...
        print("these parameters -- structure formation not supported by this run.")
