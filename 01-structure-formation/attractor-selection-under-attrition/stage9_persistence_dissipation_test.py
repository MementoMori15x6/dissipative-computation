"""
Attractor selection under attrition: does it require the same dissipative
driving that structure formation does?

The structure-formation tests found that spontaneous pattern formation
requires genuine dissipative flux -- remove it, and structure collapses
rather than merely weakening. This asks the analogous question for
attractor selection: does the differential-survival drift toward
high-persistence configurations require real dissipation
...
(metabolic_cost=0.04) -- unlike structure formation, where removing dissipation
