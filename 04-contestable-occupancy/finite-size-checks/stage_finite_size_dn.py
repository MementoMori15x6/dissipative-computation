...
def run_condition(D_bg, D_diff, K, seed=0, warmup=WARMUP_STEPS, window=WINDOW_STEPS, grid_n=N):
...
if __name__ == "__main__":
    print("Sanity check: Game of Life (A) vs Day and Night (B), contestable occupancy\n")
